...
The underscore character ('\_') can be used in the following situations.
  ...
  - In an application object that is created within the specific model using [model acronim](model-naming.md). For example: TaxReport\_BE, LedgerJournalizeTrans\_ES.
